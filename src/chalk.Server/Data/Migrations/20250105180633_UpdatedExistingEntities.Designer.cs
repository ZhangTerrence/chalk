...
namespace chalk.Server.Data.Migrations
{
    ...
    [Migration("20250105180633_UpdatedExistingEntities")]
    partial class UpdatedExistingEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("chalk.Server.Entities.ChannelUser", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint")
                        .HasColumnName("user_id");
                    ...
                    b.HasIndex("CourseRoleId")
                        .HasDatabaseName("ix_channel_users_course_role_id");

                    b.HasIndex("OrganizationRoleId")
                        .HasDatabaseName("ix_channel_users_organization_role_id");

                    b.HasIndex("ChannelId", "CourseRoleId")
                        .HasDatabaseName("ix_channel_users_channel_id_course_role_id");
            ...
            modelBuilder.Entity("chalk.Server.Entities.Attachment", b =>
                {
                    b.HasOne("chalk.Server.Entities.Assignment", "Assignment")
                        ...
                        .HasConstraintName("fk_attachments_assignment_assignment_id");
            ...
            modelBuilder.Entity("chalk.Server.Entities.ChannelUser", b =>
                {
                    ...
                    b.HasOne("chalk.Server.Entities.CourseRole", "CourseRole")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_channel_users_course_roles_course_role_id");

                    b.HasOne("chalk.Server.Entities.OrganizationRole", "OrganizationRole")
                        .WithMany("Channels")
                        .HasForeignKey("OrganizationRoleId")
                        .HasConstraintName("fk_channel_users_organization_roles_organization_role_id");
                    ...
                    b.HasOne("chalk.Server.Entities.ChannelRolePermission", "RolePermission")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_channel_users_channel_role_permissions_channel_id_course_ro");
            ...
            modelBuilder.Entity("chalk.Server.Entities.Message", b =>
                {
                    ...
                    b.HasOne("chalk.Server.Entities.ChannelUser", "User")
                        .WithMany("Messages")
                        .HasForeignKey("ChannelId", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_messages_channel_users_channel_id_user_id");
            ...
            modelBuilder.Entity("chalk.Server.Entities.Submission", b =>
                {
                    b.HasOne("chalk.Server.Entities.Assignment", "Assignment")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_submissions_assignment_assignment_id");
